        ...
        <section className="hero-main relative py-20 md:pt-32">
            ...
            <div className="flex flex-col items-center justify-center h-full">
                ...
                <div>
                    ...
                    <div className="grid gap-5 md:grid-cols-4 text-center m-auto  xl:max-w-5xl lg:max-w-full four-cards">
                        <div data-aos="zoom-in" className=" main-cards hover-text-white p-3 pt-0 relative pink hover:text-white rounded-2.5xl  border-jacarta-100 bg-white  transition-shadow  dark:border-jacarta-700 dark:bg-jacarta-700">
                            <div className="mb-2 -mt-10 bg-gradient home-cards inline-flex xl:h-[5.5rem] xl:w-[5.5rem] lg:h-[4.5rem] lg:w-[4.5rem] items-center justify-center rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    width="24"
                                    height="24"
                                    className="h-12 w-12 fill-[#590054]">
                        ...
                        <div data-aos="zoom-in" className="main-cards hover-text-white blue pb-5 relative  hover:text-white rounded-2.5xl  border-jacarta-100 bg-white  shadow-[0_5px_0_0_#8358ff] transition-shadow hover:shadow-[0_16px_24px_-8px_rgba(131,88,255,.3)] dark:border-jacarta-700 dark:bg-jacarta-700">
                            <div className="mb-4 -mt-10  bg-gradient home-cards inline-flex xl:h-[5.5rem] xl:w-[5.5rem] lg:h-[4.5rem] lg:w-[4.5rem] items-center justify-center rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    width="24"
                                    height="24"
                                    className="h-12 w-12 fill-[#016764]">
                                    <path fill="none" d="M0 0h24v24H0z" />
                        ...
                        <div data-aos="zoom-in" className="main-cards hover-text-white orange  hover:text-white pb-5 relative rounded-2.5xl  border-jacarta-100 bg-white  shadow-[0_5px_0_0_#8358ff] transition-shadow hover:shadow-[0_16px_24px_-8px_rgba(131,88,255,.3)] dark:border-jacarta-700 dark:bg-jacarta-700">
                            <div className="mb-4 -mt-10 bg-gradient home-cards inline-flex xl:h-[5.5rem] xl:w-[5.5rem] lg:h-[4.5rem] lg:w-[4.5rem] items-center justify-center rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    width="24"
                                    height="24"
                                    className="h-12 w-12 fill-[#450077]">
                                    <path fill="none" d="M0 0h24v24H0z" />
                        ...
                        <div data-aos="zoom-in" className="main-cards hover-text-white accent  hover:text-white pb-5 relative rounded-2.5xl  border-jacarta-100 bg-white  shadow-[0_5px_0_0_#8358ff] transition-shadow hover:shadow-[0_16px_24px_-8px_rgba(131,88,255,.3)] dark:border-jacarta-700 dark:bg-jacarta-700">
                            <div className="mb-4 -mt-10 bg-gradient home-cards inline-flex xl:h-[5.5rem] xl:w-[5.5rem] lg:h-[4.5rem] lg:w-[4.5rem] items-center justify-center rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    width="24"
                                    height="24"
                                    className="h-12 w-12 fill-[#130F41]">
                                    <path fill="none" d="M0 0h24v24H0z" />
