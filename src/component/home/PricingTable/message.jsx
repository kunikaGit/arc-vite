...
const useMessageData = () => {
    ...
    const handleOpenModal = (type) => {
        ...
        switch (type) {
            case "minTrade":
                content =
                    `During each stage of our evaluation, there are a minimum of 3 trading days. A day is counted as a trading day if at least one trade is executed. 
                    Holding a trade over multiple days will not count as multiple trading days.\n \n
                    Note:
