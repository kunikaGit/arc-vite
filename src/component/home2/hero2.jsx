    ...
    return (
        <section className="hero-main relative py-20 md:pt-32">
            ...
            <div className="container">
                <div className="pt-10 text-center m-auto xl:max-w-4xl lg:max-w-full hero-text">
                ...
                <div className="grid gap-5 md:grid-cols-4 text-center m-auto  xl:max-w-4xl lg:max-w-full four-cards">
