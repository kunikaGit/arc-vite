...
generalQuestions: [
    ...
    evaluationProcess: [
      ...
      },
      {
        ...
        answer:
          "Traders must adhere to risk parameters, including:\n- Profit Target: Earn a set percentage of initial capital.\n- Max Daily Loss: Do not exceed the specified daily loss limit.\n- Overall Drawdown: Maintain account balance above a defined threshold.\n- Minimum Trading Days: Trade a minimum number of days to ensure consistency.",
      },
      {
        id: 7,
        question: "Can I retry the evaluation if I fail?",
        answer:
          "Yes, traders can retake the evaluation at a discounted fee or for free if they followed risk rules but didn't reach the profit target.",
      },
    ],
    fundedAccounts: [
      {
        ...
        answer:
          "After passing the evaluation, traders receive access to a live funded account and can start earning real profits.",
      },
      {
        id: 9,
      ...
      },
      {
        ...
        answer:
          "If a trader breaches the max drawdown limit, the account is deactivated. Some firms offer reset options, while others require re-evaluation.",
      },
    ],
    tradingConditions: [
      {
        ...
        answer:
          "We provide access to MetaTrader 4, MetaTrader 5, and cTrader, along with custom dashboards for analytics.",
      },
      {
        id: 13,
      ...
      },
      {
        ...
        answer:
          "We allow most strategies, including scalping, swing trading, and algorithmic trading, but prohibit high-frequency trading (HFT), latency arbitrage, and account abuse.",
      },
      {
        id: 15,
    ...
    payoutsAndWithdrawals: [
      ...
      },
      {
        ...
        answer: "Withdrawals can be made bi-weekly or monthly, depending on the account type.",
      },
      {
        id: 18,
    ...
    supportAndExtras: [
      ...
      },
      {
        ...
        answer:
          "To get started, visit our registration page, choose an evaluation plan, and begin trading.",
      },
    ],
  };
