  ...
  return (
    <div>
      ...
      <div className="terms-content mx-auto ">
        <h2 className="text-md mb-3 text-jacarta-700 dark:text-white">1. Introductory Provisions</h2>
        <ul className="list-disc text-jacarta-700 pl-7 text-jacarta-700 dark:text-white">
        ...
        <h2 className="text-md text-jacarta-700 dark:text-white">2. Services and Their Order</h2>
        <ul className=" list-disc text-jacarta-700 pl-5 space-y-2 dark:text-white">
          <li>You can order services through the ARC Capital website by completing a registration or order form.</li>
          <li>Services include the Learn More, ARC Capital Challenge, and Verification, each differing in scope.</li>
          <li>All provided data must be complete, accurate, and up to date.</li>
          <li>If you register as a business, consumer protection laws may not apply.</li>
          <li>Fees vary based on account size, risk level, and challenge conditions.</li>
          <li>Fees for the ARC Capital Challenge are non-refundable.</li>
          <li>Disputing a paid fee may result in service suspension.</li>
          <li>Selected challenge settings apply to the Verification stage and cannot be changed.</li>
          <li>Service fees may update, but changes do not affect existing purchases.</li>
          <li>Before ordering, details can be reviewed and edited. Orders finalize upon payment.</li>
          <li>Customers are responsible for acquiring necessary technical equipment.</li>
          <li>Third-party trading platforms have their own terms and policies.</li>
          <li>High-frequency ordering may result in warnings or suspensions.</li>
        </ul>

        <h2 className="text-md text-jacarta-700 dark:text-white">3. Payment Terms </h2>
        <ul className="list-disc text-jacarta-700 pl-5 space-y-2 dark:text-white">
          <li>Fees for the ARC Capital Challenge are in euros, but payments can be made in other currencies listed on the website. Conversion rates will apply for different currencies.</li>
        ...
        <h2 className="text-md text-jacarta-700 dark:text-white">4. Client Section and Trading Platform</h2>
        <ul className="list-disc text-jacarta-700 pl-5 space-y-2 dark:text-white">
        ...
        <h2 className="text-md text-jacarta-700 dark:text-white">5. Rules of Demo Trading</h2>
        <ul className="list-disc text-jacarta-700 pl-5 space-y-2 dark:text-white">
          <li>Customers may trade freely during demo trading unless they engage in Forbidden Trading Practices. They must follow market-standard trading rules, including proper risk management. Additional restrictions may apply based on the trading platform's conditions.</li>
          ...
          <li>Forbidden Trading Practices
          </li>
          <h3 className="text-jacarta-700 dark:text-white text-base font-medium mb-0">During demo trading, customers are prohibited from:</h3>
          <ul className="list-disc text-jacarta-700 pl-10 dark:text-white">
          ...
          <h3 className="text-jacarta-700 dark:text-white text-base font-medium">Additionally, customers may NOT:</h3>
          <ul className="list-disc text-jacarta-700 pl-10 dark:text-white">
          ...
          <h3><strong>Improper risk management </strong>— such as placing unusually large positions compared to normal trades—may also be deemed a violation.
            <strong> ARC Capital reserves the right to determine whether a trade violates these rules</strong></h3>
        </ul>
        <h2 className="text-md text-jacarta-700 dark:text-white">6. Risk Disclaimer</h2>
        <ul className="list-disc text-jacarta-700 pl-10 dark:text-white">
          ...
          <h3 className="text-jacarta-700 dark:text-white text-base font-medium mb-0">Challenge Activation</h3>
          <ul className="list-disc text-jacarta-700 pl-10 dark:text-white">
          ...
          <h3 className="text-jacarta-700 dark:text-white text-base font-medium mb-0">Challenge Requirements</h3>
          <p className="text-jacarta-700 dark:text-white">To successfully complete the ARC Capital Challenge, the customer must:</p>
          <ul className="list-disc text-jacarta-700 pl-5 space-y-2 dark:text-white">
            <li>Trade on at least four different days.</li>
            <li>Not exceed the maximum daily loss limit:</li>
            <ol className="pl-14 text-jacarta-700 dark:text-white">
              <li>Standard: 5% of initial capital</li>
              <li>Aggressive: 10% of initial capital</li>
              <li>Swing: 5% of initial capital</li>
            </ol>
            <li>Not exceed the maximum total loss limit:</li>
            <ul className="list-disc text-jacarta-700 pl-5 dark:text-white">
              <li>Standard: 10% of initial capital</li>
              <li>Aggressive: 20% of initial capital</li>
              <li>Swing: 10% of initial capital</li>
            </ul>
            <li>Achieve a total profit goal:</li>
            <ul className="list-disc text-jacarta-700 pl-5 dark:text-white">
              <li>Standard: 10% of initial capital</li>
              <li>Aggressive: 20% of initial capital</li>
              <li>Swing: 10% of initial capital</li>
