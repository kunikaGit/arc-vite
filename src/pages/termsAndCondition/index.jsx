      ...
      <section className="relative py-16 dark:bg-jacarta-800 md:py-24 termconditions">
        ...
        <div className="container">
          ...
          <div className="terms-content mx-auto ">
            <h2 className="text-md mb-3">1. Introductory Provisions</h2>
            ...
            <h2 className="text-md">2. Services and Their Order</h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
              <li>You can order services through the ARC Capital website by completing a registration or order form.</li>
              <li>Services include the Free Trial, ARC Capital Challenge, and Verification, each differing in scope.</li>
            ...
            <h2 className="text-md">3. Payment Terms </h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <h2 className="text-md">4. Client Section and Trading Platform</h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <h2 className="text-md">5. Rules of Demo Trading</h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <h2 className="text-md">6. Risk Disclaimer</h2>
            <ul>
              ...
              <p>To successfully complete the ARC Capital Challenge, the customer must:</p>
              <ul className="list-disc pl-5 space-y-2 text-gray-700">
              ...
              <p>If these conditions are met, ARC Capital grants access to the Verification phase for free. However, all trades must be closed before evaluation.</p>
            </ul>
          </div>
        </div>
      </section>
