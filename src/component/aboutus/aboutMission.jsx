        ...
        <>
            <section className="background-overlay-custom mission-wrapped ">
                ...
                <div className="content">
                    ...
                    <p className="text-lg font-light " data-aos="fade-up" data-aos-duration={800} >Our mission is simple: to offer traders the opportunity to succeed with real liquidity and
