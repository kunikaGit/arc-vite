      ...
      <section className="relative py-16 dark:bg-jacarta-800 md:py-24 termconditions">
        ...
        <div className="container">
          ...
          <div className="article-content mx-auto ">
            <h2 className="text-md mb-3">Introductory Provisions</h2>
            <ul>
            ...
            <h2 className="text-md">Services and Their Order</h2>
            ...
            <h2 className="text-md">Payment Terms </h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <h2 className="text-md">Client Section and Trading Platform</h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <h2 className="text-md">Rules of Demo Trading</h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
              ...
              <li>Forbidden Trading Practices
                ...
                <h3 className="text-black dark:text-white text-base font-medium mb-0">During demo trading, customers are prohibited from:</h3>
                ...
                <h3  className="text-black dark:text-white text-base font-medium">Additionally, customers may NOT:</h3>
                <ul className="list-disc pl-10">
