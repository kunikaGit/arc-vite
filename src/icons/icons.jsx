...
export const DoubleUp = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#8358ff" width="24" height="24">
        <path d="M12 4.83582L5.79291 11.0429L7.20712 12.4571L12 7.66424L16.7929 12.4571L18.2071 11.0429L12 4.83582ZM12 10.4857L5.79291 16.6928L7.20712 18.107L12 13.3141L16.7929 18.107L18.2071 16.6928L12 10.4857Z"></path></svg>
)

export const UserHeart = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#8358ff" width="24" height="24"><path d="M17.841 15.659L18.017 15.836L18.1945 15.659C19.0732 14.7803 20.4978 14.7803 21.3765 15.659C22.2552 16.5377 22.2552 17.9623 21.3765 18.841L18.0178 22.1997L14.659 18.841C13.7803 17.9623 13.7803 16.5377 14.659 15.659C15.5377 14.7803 16.9623 14.7803 17.841 15.659ZM12 14V22H4C4 17.6651 7.44784 14.1355 11.7508 14.0038L12 14ZM12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1Z"></path></svg>
)
...
export const EqualIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M3 7C3 5.067 4.567 3.5 6.5 3.5C8.433 3.5 10 5.067 10 7C10 8.933 8.433 10.5 6.5 10.5C4.567 10.5 3 8.933 3 7ZM20 8H12V6H20V8ZM14 17C14 15.067 15.567 13.5 17.5 13.5C19.433 13.5 21 15.067 21 17C21 18.933 19.433 20.5 17.5 20.5C15.567 20.5 14 18.933 14 17ZM12 16V18H4V16H12Z"></path></svg>
)
...
export const FileIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M20 22H4C3.44772 22 3 21.5523 3 21V3C3 2.44772 3.44772 2 4 2H20C20.5523 2 21 2.44772 21 3V21C21 21.5523 20.5523 22 20 22ZM8 7V9H16V7H8ZM8 11V13H16V11H8ZM8 15V17H16V15H8Z"></path></svg>
)
...
export const CalenderIcon = () => (
  ...
  export const DownIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="12" height="7" viewBox="0 0 12 7" fill="none">
        <path fillRule="evenodd" clipRule="evenodd" d="M6.58926 6.59222C6.43299 6.74845 6.22106 6.83621 6.00009 6.83621C5.77912 6.83621 5.5672 6.74845 5.41093 6.59222L0.696759 1.87805C0.617167 1.80118 0.553681 1.70923 0.510007 1.60756C0.466333 1.50589 0.443345 1.39654 0.442384 1.28589C0.441422 1.17524 0.462507 1.0655 0.504408 0.963091C0.546309 0.860678 0.608187 0.767634 0.686431 0.68939C0.764675 0.611146 0.857717 0.549268 0.960131 0.507368C1.06254 0.465467 1.17228 0.444382 1.28293 0.445344C1.39358 0.446305 1.50293 0.469294 1.6046 0.512968C1.70627 0.556642 1.79822 0.620127 1.87509 0.699719L6.00009 4.82472L10.1251 0.699719C10.2823 0.547921 10.4928 0.463925 10.7113 0.465824C10.9298 0.467723 11.1388 0.555363 11.2933 0.70987C11.4478 0.864377 11.5354 1.07339 11.5373 1.29188C11.5392 1.51038 11.4552 1.72088 11.3034 1.87805L6.58926 6.59222Z" />
    </svg>
)
export const Logout = () => (
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 16 15" fill="none">
<path d="M2.16667 15C1.70833 15 1.31611 14.8369 0.99 14.5108C0.663889 14.1847 0.500556 13.7922 0.5 13.3333V1.66667C0.5 1.20833 0.663333 0.816111 0.99 0.49C1.31667 0.163889 1.70889 0.000555556 2.16667 0H8V1.66667H2.16667V13.3333H8V15H2.16667ZM11.3333 11.6667L10.1875 10.4583L12.3125 8.33333H5.5V6.66667H12.3125L10.1875 4.54167L11.3333 3.33333L15.5 7.5L11.3333 11.6667Z" fill="#fff"/>
</svg>
)
